...
class BrowserProvider {
     ...
     */
    get networkConfig() {
        return types_1.NETWORKS[this._network];
    }
    /**
     * Check if connected
     */
    ...
    _detectNetwork() {
        if (this._chainId === types_1.NETWORKS.mainnet.chainId) {
            this._network = 'mainnet';
        }
        else if (this._chainId === types_1.NETWORKS.testnet.chainId) {
            this._network = 'testnet';
        }
        else if (this._chainId === types_1.NETWORKS.local.chainId) {
            this._network = 'local';
        }
    }
}
