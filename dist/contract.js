...
exports.EventDecoder = exports.ContractMethod = exports.Contract = void 0;
...
class Contract {
    ...
    async call(method, args = [], options = {}) {
        ...
        const result = await this.client.rpc.ethCall({
            ...
            data,
            from: options.from,
            value: options.value ? (0, utils_1.numberToHex)(BigInt(options.value)) : undefined
        });
    ...
    async send(wallet, method, args = [], options = {}) {
        ...
        const tx = {
            to: this.address,
            data,
            value: options.value ? (0, utils_1.numberToHex)(BigInt(options.value)) : '0x0',
    ...
    async estimateGas(method, args = [], options = {}) {
        ...
        return (0, utils_1.hexToNumber)(gasHex);
    }
    /**
     * Get past events
     */
    ...
    functionSelector(abiItem) {
        ...
        return '0x' + (0, js_sha3_1.keccak256)(signature).slice(0, 8);
    }
    /**
    ...
    static encodeParameter(type, value) {
        ...
        if (type === 'string') {
            ...
            let dataHex = (0, utils_1.bytesToHex)(bytes).slice(2);
    ...
    static decodeParameter(type, data, offset = 0) {
        ...
        if (type === 'string') {
            ...
            const bytes = (0, utils_1.hexToBytes)(strData);
...
class EventDecoder {
    constructor(abiItem) {
        ...
        this.topic = '0x' + (0, js_sha3_1.keccak256)(signature);
    }
    /**
