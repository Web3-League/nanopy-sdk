...
exports.GameSession = exports.GameRandom = exports.Rewards = exports.Achievements = exports.Leaderboard = exports.GameItems = void 0;
...
class GameItems {
    constructor(address, client) {
        ...
        this.client = client;
        this.contract = new contract_1.Contract(address, GAME_ITEM_ABI, client);
    }
    /**
     * Get item balance
     */
...
class Leaderboard {
    constructor(address, client) {
        this.address = address;
        this.client = client;
        this.contract = new contract_1.Contract(address, LEADERBOARD_ABI, client);
    }
    /**
     * Get player score
     */
...
class Achievements {
    constructor(address, client) {
        this.address = address;
        this.client = client;
        this.contract = new contract_1.Contract(address, ACHIEVEMENT_ABI, client);
    }
    /**
...
class Rewards {
    constructor(address, client) {
        this.address = address;
        this.client = client;
        this.contract = new contract_1.Contract(address, REWARDS_ABI, client);
    }
    /**
     * Get pending reward
     */
...
class GameRandom {
    ...
    static fromBlockHash(blockHash, nonce) {
        ...
        const hash = (0, js_sha3_1.keccak256)(data);
    ...
    static shuffle(seed, items) {
        ...
        for (let i = result.length - 1; i > 0; i--) {
            currentSeed = BigInt((0, js_sha3_1.keccak256)(currentSeed.toString(16)));
...
class GameSession {
    ...
    generateSessionId() {
        ...
        return '0x' + (0, js_sha3_1.keccak256)(data).slice(0, 16);
    }
    /**
