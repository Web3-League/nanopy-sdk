 ...
 */
function formatBalance(wei, symbol = 'NPY') {
...
function keccak(data) {
    if (typeof data === 'string') {
        ...
        return '0x' + (0, js_sha3_1.keccak256)(hexToBytes(cleanData));
    }
...
function toChecksumAddress(address) {
    ...
    const hash = (0, js_sha3_1.keccak256)(addr);
    let result = '0x';
    for (let i = 0; i < 40; i++) {
...
function functionSelector(signature) {
    const hash = (0, js_sha3_1.keccak256)(signature);
