 ...
 */
export function toWei(npy: string | number): bigint {
 ...
 */
export function formatBalance(wei: bigint | string, symbol: string = 'NPY'): string {
 ...
 */
export function padHex(hex: string, bytes: number = 32): string {
 ...
 */
export function keccak(data: string | Uint8Array): string {
